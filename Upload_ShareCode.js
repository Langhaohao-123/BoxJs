...
const PetCode3 = $.getdata('PetCode3');
...
const PetCode4 = $.getdata('PetCode4');
...
const PetCode5 = $.getdata('PetCode5');
...
const PetCode6 = $.getdata('PetCode6');
...
// 上传京喜工厂互助码
function UploadSurpriseCode() { // 修改
    return new Promise((resolve) => {
        const url = { 
            url: 'http://api.turinglabs.net/api/v1/jd/jxfactory/create/' + SurpriseCodeVal + '/', // 修改
            headers: {'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.2 Mobile/15E148 Safari/604.1'},
	    }
        $.get(url,(_err, resp, data)=> {  
            try {
